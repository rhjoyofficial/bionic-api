                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="sm:col-span-2 sm:grid sm:grid-cols-2 gap-4 flex flex-col">
                                <div>
                                    ...
                                    <input id="co_name" type="text" placeholder="Your full name"
                                ...
                                <div>
                                    ...
                                    <input id="co_phone" type="tel" placeholder="01XXXXXXXXX"
                                        class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-300 focus:border-green-400 transition-all">
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input id="co_email" type="email" placeholder="you@example.com"
                                    class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-300 focus:border-green-400 transition-all">
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea id="co_address" rows="2" placeholder="House no., road, area..."
                            ...
                            <div>
                                ...
                                <input id="co_city" type="text" placeholder="Dhaka"
                                    class="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-300 focus:border-green-400 transition-all">
                            </div>
                ...
                <div class="lg:col-span-1 sticky top-8 space-y-4">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                        ...
                        <div class="space-y-2.5 pt-2 border-t border-gray-100">
                            ...
                            <div class="flex justify-between text-sm text-gray-500">
                                <span>Shipping</span>
                                <span id="coShipping" class="font-semibold text-gray-800 font-bengali">Select zone</span>
                            </div>
