...
<div x-data="productList()" x-init="init()">
    ...
    <div class="bg-white border border-gray-200 rounded-xl mb-4 p-4 flex flex-col sm:flex-row gap-3">
        ...
        <p class="text-sm text-gray-500 self-center ml-auto" x-text="meta.total !== undefined ? meta.total + ' products' : ''"></p>
    </div>
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <template x-if="loading">
                        <template x-for="i in 8" :key="i">
                            <tr>
                                <td class="px-5 py-4"><div class="w-10 h-10 bg-gray-100 rounded-lg animate-pulse"></div></td>
                                <td class="px-5 py-4"><div class="h-4 bg-gray-100 rounded animate-pulse w-40"></div></td>
                                <td class="px-5 py-4"><div class="h-4 bg-gray-100 rounded animate-pulse w-24"></div></td>
                                <td class="px-5 py-4"><div class="h-4 bg-gray-100 rounded animate-pulse w-10"></div></td>
                                <td class="px-5 py-4"><div class="h-4 bg-gray-100 rounded animate-pulse w-16"></div></td>
                                <td class="px-5 py-4"><div class="h-4 bg-gray-100 rounded animate-pulse w-16"></div></td>
                                <td class="px-5 py-4"><div class="h-4 bg-gray-100 rounded animate-pulse w-20"></div></td>
                            </tr>
                        </template>
                    </template>
                            ...
                            <tr class="hover:bg-gray-50 transition">
                                <td class="px-5 py-3">
                                    <template x-if="product.image_url">
                                        <img :src="product.image_url" class="w-10 h-10 rounded-lg object-cover border border-gray-100">
                                    </template>
                                    <template x-if="!product.image_url">
                                ...
                                <td class="px-5 py-3">
                                    <span class="inline-flex items-center px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 text-xs font-medium"
    ...
    <div x-show="showDeleteModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4"
        ...
        <div class="relative bg-white rounded-xl shadow-xl w-full max-w-sm p-6 text-center"
            ...
            <p class="text-xs text-gray-400 mb-5">This will remove the product, all variants, and images permanently.</p>
