        ...
        <div>
            ...
            <div class="flex items-center justify-between mb-6">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-gray-800">Edit Combo</h2>
                        <p class="text-sm text-gray-500 mt-0.5 font-mono" x-text="form.slug"></p>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-3">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    ...
                                    <span class="text-sm text-gray-700">Auto <span class="text-xs text-gray-400">(sum of components)</span></span>
                                </label>
                                <label class="flex items-center gap-2 cursor-pointer">
