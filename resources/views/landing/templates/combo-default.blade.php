...
@section('content')
    <section class="bg-[#f0f5f1] min-h-screen" x-data="comboLanding()" x-init="init()">
            ...
            <div class="max-w-7xl mx-auto px-4 py-12 md:py-20">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                    ...
                    <div>
                        ...
                        {{-- What's Inside --}}
                        <div class="mb-6">
                            <h3 class="text-sm font-semibold text-green-200 mb-3 uppercase tracking-wider">What's Inside
                            </h3>
                            <div class="space-y-2">
